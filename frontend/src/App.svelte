<script>
  ...
  import Skidsteer from './components/skidsteer.svelte'; // <-- TOEGEVOEGD: Skidsteer import
...
<main class="container">
  <header>
    ...
    <nav class="tabs">
      ...
      <button class:active={activeTab === 'skidsteer'} on:click={() => activeTab = 'skidsteer'}>Skidsteer</button> 
...
<style>
  ...
  .tabs {
      display: flex;
      overflow-x: auto;
      /* Sta horizontaal swipen toe op mobiel */
      white-space: nowrap;
      /* Voorkom dat tekst afbreekt in de knop */
      gap: 5px;
      /* Ruimte tussen knoppen */
      padding-bottom: 5px;
      -webkit-overflow-scrolling: touch;
      /* Soepel swipen op iPhones */
      scrollbar-width: none;
      /* Verberg scrollbar in Firefox */
  }
  ...
  .tabs button { 
      flex: 0 0 auto;
      /* Zorgt dat knoppen niet in elkaar gedrukt worden */
      padding: 12px 16px;
      /* Iets groter klik-oppervlak voor vingers */
      border: none; 
      background: #ddd; 
      cursor: pointer; 
      border-radius: 6px;
